...
for alim_id in alimentadores_asa_sul:
...
# --- DADOS ---
        ...
        for _, row in ssdmt.iterrows():
            ...
            ultimo_cod_trafo = cod
            if ultimo_cod_trafo is None:
                print("Sem transformadores.")
                continue
        ...
        if dss.solution.converged:
            ...
            print(f"Cheguei ao append do {alim_id}")
            print("9 - vou adicionar resultado")
            resultados.append({
                "alimentador": alim_id,
                "barras": dss.circuit.num_buses,
                "loads": dss.loads.count,
                "potencia_kva": kva_total_cenario,
                "perdas_kwh": e_loss_m1,
                "perdas_pct": perc,
                "vmin_pu": v_min
            })
            print("Append realizado")
        else:
