...
# 🚀 CONFIGURAÇÃO DE LISTA: Adicione aqui os alimentadores que deseja comparar em sequência
alimentadores_para_analisar = ["ES01", "ES02"]
...
for alim_id in alimentadores_para_analisar:
    ...
    cenarios = [
        ...
        ("Estresse Geral (20x)", 20.0, False),
        ("Carga Crítica no Fim", 1.2, True)
    ]

    # Loop de Cenários de Estresse para o alimentador atual
    for nome_cenario, fator_mult, add_carga_fim in cenarios:
        ...
        # --- ADICIONAR CARGA CRÍTICA (Se o cenário atual pedir) ---
        if add_carga_fim:
...
print("\n🚀 Todos os alimentadores da lista foram simulados na Task 7 com sucesso!")